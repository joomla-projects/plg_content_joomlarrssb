...
<div class="share-container">
	<ul class="rrssb-buttons clearfix">
		...
		<li class="rrssb-facebook">
			<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($itemURL); ?>" class="popup">
				<span class="rrssb-icon">
		...
		<?php endif; ?>
		<?php if ($displayGoogle) : ?>
			<li class="rrssb-googleplus">
				<a href="https://plus.google.com/share?url=<?php echo urlencode($itemURL); ?>" class="popup">
					<span class="rrssb-icon">
						<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
		...
		<?php if ($displayPinterest) : ?>
			<li class="rrssb-pinterest">
				<a href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode($itemURL); ?>&amp;media=<?php echo urlencode($pinterestImage); ?>&amp;description=<?php echo urlencode($article->title); ?>">
					<span class="rrssb-icon">
						<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
